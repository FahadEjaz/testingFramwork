...
const SPEC = 'tests/zzz.spec.ts';

// Recorded via the in-app recorder (Phase 6) — see manifests/zzz.json for
...
test('zzz', async ({ page }) => {
  ...
  await (await resilientLocator(page, SPEC, 'element4', () => page.locator('a > img'))).click();
});
